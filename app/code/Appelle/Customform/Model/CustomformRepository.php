...
namespace Appelle\Customform\Model;

use Appelle\Customform\Api\CustomformRepositoryInterface;
use Appelle\Customform\Api\Data\CustomformInterfaceFactory;
use Appelle\Customform\Api\Data\CustomformSearchResultsInterfaceFactory;
use Appelle\Customform\Model\ResourceModel\Customform as ResourceCustomform;
use Appelle\Customform\Model\ResourceModel\Customform\CollectionFactory as CustomformCollectionFactory;
...
class CustomformRepository implements CustomformRepositoryInterface
{
    ...
    public function save(
        ...
        $customformData = $this->extensibleDataObjectConverter->toNestedArray(
            $customform,
            [],
            \Appelle\Customform\Api\Data\CustomformInterface::class
        );
