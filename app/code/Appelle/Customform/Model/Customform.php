...
class Customform extends \Magento\Framework\Model\AbstractModel
{
    ...
    protected $_eventPrefix = 'Appelle_customform';
     ...
     * @param \Appelle\Customform\Model\ResourceModel\Customform $resource
     * @param \Appelle\Customform\Model\ResourceModel\Customform\Collection $resourceCollection
     * @param array $data
     */
    public function __construct(
        ...
        \Appelle\Customform\Model\ResourceModel\Customform $resource,
        \Appelle\Customform\Model\ResourceModel\Customform\Collection $resourceCollection,
        array $data = []
    ) {
