...
namespace Appelle\Customform\Controller\Index;

use Magento\Framework\App\Action\Context;
use Appelle\Customform\Model\CustomformFactory;
	...
	public function execute()
    {
        ...
        if(isset($_FILES['image']['name']) && $_FILES['image']['name'] != '') {
            try{
                ...
                $imagePath = 'Appelle/customform'.$result['file'];
        ...
        $resultRedirect->setPath('callbackform');
...
/**
    ...
    private function validatedParams()
    {
        ...
        if (trim($request->getParam('full_name')) === '') {
