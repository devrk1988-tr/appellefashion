...
namespace Appelle\Customform\Controller\Adminhtml\Customform;

class Edit extends \Appelle\Customform\Controller\Adminhtml\Customform
{
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create(\Appelle\Customform\Model\Customform::class);
        ...
        $this->_coreRegistry->register('appelle_customform', $model);
