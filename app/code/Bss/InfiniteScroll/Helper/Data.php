...
class Data extends \Magento\Framework\App\Helper\AbstractHelper implements \Magento\Framework\View\Element\Block\ArgumentInterface
{
     ...
     * @return int
     */
    public function getCatalogPageSize() {
        return (int)$this->scopeConfig
            ->getValue('catalog/frontend/grid_per_page_values', ScopeInterface::SCOPE_STORE);
    }
    ...
    public function getPageVarName() {
        ...
        return $this->pager->getPageVarName();
    }

    /**
     * Is enable layerNavigation
     *
     * @return int
     */
    public function isEnableLayerNavigation()
    {
        $configEnable = $this->scopeConfig->isSetFlag(
            'layered_navigation/general/enable',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
        if ($configEnable && $this->isInstallLayerNavigation()) {
            return 1;
        } else {
            return 0;
        }
    ...
    /**
     * Check is install LayerNavigation
     *
     * @return bool
     */
    public function isInstallLayerNavigation()
    {
        return $this->moduleManager->isEnabled('Bss_LayerNavigation');
    }
