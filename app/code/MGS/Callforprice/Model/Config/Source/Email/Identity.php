 ...
 */
namespace MGS\Callforprice\Model\Config\Source\Email;
...
class Identity implements \Magento\Framework\Option\ArrayInterface
{
    ...
    public function toOptionArray()
    {
        if ($this->_options === null) {
            ...
            $section = $this->_configStructure->getElement('mgscallforprice_email');

            /** @var $group \Magento\Config\Model\Config\Structure\Element\Group */
            foreach ($section->getChildren() as $group) {
                $this->_options[] = [
                    'value' => preg_replace('#^mgs_(.*)$#', '$1', $group->getId()),
